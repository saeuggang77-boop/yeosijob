    ...
    <div className="mx-auto max-w-screen-md px-4 py-10">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <p className="mt-2">
            <strong className="text-foreground">서비스 홍보 안내:</strong> 이력서가 공개(isPublic)로 등록될 경우, 개인을 식별할 수 없는 범위의
            정보(희망 지역의 광역시 단위, 희망 업종, 연령대(10년 단위), 경력 수준 카테고리, 희망 급여 형태)만
            여시잡 공식 홍보 채널(텔레그램 등)에 게시될 수 있습니다.
            이름, 정확한 나이, 사진, 연락처, 카카오톡 ID, 상세 주소 등 개인식별정보는 일절 포함되지 않습니다.
          </p>
        </section>
