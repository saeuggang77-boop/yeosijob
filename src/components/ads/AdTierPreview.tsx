export function AdTierPreview() {
  const tiers = [
    ...
    { id: "SPECIAL", label: "스페셜", price: "13만원/30일", style: "border-t-2 border-t-special bg-special/5", desc: "퍼플 강조 + 상단 노출" },
    { id: "URGENT", label: "급구", price: "10만원/30일", style: "border-l-4 border-l-urgent bg-urgent/5", desc: "빨간 급구뱃지 + 펄스" },
