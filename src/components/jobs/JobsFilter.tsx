    ...
    <div className="sticky top-14 z-40 border-b bg-background">
      ...
      <div className="flex items-center gap-2 px-4 py-2 md:hidden">
        <div className="flex flex-1 flex-wrap items-center gap-1.5">
          <span className={`rounded-full border px-2.5 py-1 text-xs ${currentRegion ? "border-primary text-primary" : "border-border text-muted-foreground"}`}>
            {regionLabel}
          </span>
          <span className={`rounded-full border px-2.5 py-1 text-xs ${currentBusinessType ? "border-primary text-primary" : "border-border text-muted-foreground"}`}>
            {bizLabel}
          </span>
        ...
        <div className="border-t border-border px-4 pb-3 pt-2 md:hidden">
          <form action="/jobs" method="get" className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <select name="sort" defaultValue={currentSort} className="h-10 flex-1 rounded-md border bg-background px-3 text-sm">
